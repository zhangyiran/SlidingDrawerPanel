package com.sothree.slidingdrawerpanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private float mTitleSlideOffset;
    ...
    public int getCurrentParallaxOffset() {
        ...
        Log.d("testui","mSlideOffset="+mSlideOffset);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child == mSlideableView) {
                mSlideRange = mSlideableView.getMeasuredHeight() - mPanelHeight - mTitleView.getMeasuredHeight();
            } else if (child == mTitleView) {
                mTitleSlideRange = mTitleView.getMeasuredHeight();
            }
        }
    ...
    private int computeTitleTopPosition(float slideOffset) {
        //int slidingViewHeight = mSlideableView != null ? mSlideableView.getMeasuredHeight() : 0;
        int slidePixelOffset = (int) (slideOffset * mTitleSlideRange);
        // Compute the top of the panel if its collapsed
        return slidePixelOffset;
     ...
     * Computes the slide offset based on the top position of the panel
     */
    private float computeTitleSlideOffset(int topPosition) {
        // Compute the panel top position if the panel is collapsed (offset 0)
        final int topBoundCollapsed = computePanelTopPosition(0);
    ...
    private void onPanelDragged(int newTop) {
        ...
        mSlideOffset = computeSlideOffset(newTop);
        mTitleSlideOffset = computeTitleSlideOffset(newTop);

        applyParallaxForCurrentSlideOffset();

        mTitleView.setTranslationY(computeTitleTopPosition(mTitleSlideOffset));
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mMainView == child) { // if main view
            ...
            mTmpRect.top = mTitleView.getBottom();
